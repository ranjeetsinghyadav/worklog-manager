        ...
        <g:form action='requestmapSearch' name='requestmapSearchForm'>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><g:textField name='configAttribute' size='50' maxlength='255' autocomplete='off'
                                     value='${configAttribute}'/></td>
                </tr>
                <tr><td colspan='2'>&nbsp;</td></tr>
                <tr>
                    <td colspan='2'><s2ui:submitButton elementId='search' form='requestmapSearchForm'
